...
#sys.path.insert(0, os.path.join(PROJECT_ROOT, 'media'))
...
SECRET_KEY = '7kxdh2!@x1aiim17^asux0b0uzxh_g!3rlfn_p)(giv#%$2vef'
...
STATICFILES_DIRS = (
os.path.join(BASE_DIR, 'static'), '/apps/tours/static/', ####!!!
)
